// this will make sure we can execute methods like `fs.writeFileSync()` without actually
// writing to a file, so this will prevent us from accidently creating new animals everytime
// we run a test
jest.mock('fs');
const fs = require('fs');
